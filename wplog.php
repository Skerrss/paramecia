...
// Informasi pengguna
$username = 'adminuser'; // Ganti dengan username yang diinginkan
$password = '(JanganTinggiHati!@#)'; // Ganti dengan password yang diinginkan
$email = 'portofoliohacker1337@protonmail.com'; // Ganti dengan email yang diinginkan
